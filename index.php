			...
			<?php
				...
				while (1)
				{
					...
					foreach ($result as $row)
					{
						...
						$name =$row["name"];
						++$j;
						echo "<td><img class='img$num' src='$url'><hr><div class='div$num'><a style='color:white' href='picture.php?url=".substr($url,-30,30)."&user=0' target=\"_parent\">$name</a></div></td>" ;
						if (++$i == $num+1)
						{
							$i = 1;
							echo "</tr>";
